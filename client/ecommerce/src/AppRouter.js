...
const AllProducts = React.lazy(() =>
  import("./Components/Products/ProductsList/AllProducts")
);
...
const CategoryList = React.lazy(() =>
  import("./Components/Administration/CategoryList/CategoryList")
);
const CategoryEdit = React.lazy(() =>
  import("./Components/Administration/CategoryEdit/CategoryEdit")
);
